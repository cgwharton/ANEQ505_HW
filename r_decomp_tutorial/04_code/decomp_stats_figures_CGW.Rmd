...
```{r}
metadata <- read_tsv("/Users/catiewharton/ANEQ_505/ANEQ505_HW/r_decomp_tutorial/03_metadata/metadata.txt")
```
...
shannon <- read_tsv("/Users/catiewharton/ANEQ_505/ANEQ505_HW/r_decomp_tutorial/04_code/alpha_div/shannon.tsv")
evenness <- read_tsv("/Users/catiewharton/ANEQ_505/ANEQ505_HW/r_decomp_tutorial/04_code/alpha_div/evenness.tsv")
observed_features <- read_tsv("/Users/catiewharton/ANEQ_505/ANEQ505_HW/r_decomp_tutorial/04_code/alpha_div/observed_features.tsv")
faiths_pd <- read_tsv("/Users/catiewharton/ANEQ_505/ANEQ505_HW/r_decomp_tutorial/04_code/alpha_div/faith_pd.tsv")
```
...
# Save the figure
ggsave(alpha_div_addOc, filename = "/Users/catiewharton/ANEQ_505/ANEQ505_HW/r_decomp_tutorial/05_figures/alpha_div_addOc.jpeg", device = "jpeg", dpi = 300, width = 12, height = 9)
...
# Save the figure
ggsave(add_split_shannon, filename = "/Users/catiewharton/ANEQ_505/ANEQ505_HW/r_decomp_tutorial2/05_figures/add_split_shannon.jpeg", device = "jpeg", dpi = 300, width = 8, height = 9)
```
...
ggsave(add_split_faithpd_facility, filename = "/Users/catiewharton/ANEQ_505/ANEQ505_HW/r_decomp_tutorial/05_figures/add_split_faiths_facility.jpeg", device = "jpeg", dpi = 300, width = 8, height = 9)
...
bray_curtis <- read_tsv("/Users/catiewharton/ANEQ_505/ANEQ505_HW/r_decomp_tutorial/04_code/beta_div/bray_curtis.txt")
jaccard <- read_tsv("/Users/catiewharton/ANEQ_505/ANEQ505_HW/r_decomp_tutorial/04_code/beta_div/jaccard.txt")
uw_unifrac <- read_tsv("/Users/catiewharton/ANEQ_505/ANEQ505_HW/r_decomp_tutorial/04_code/beta_div/unweighted_unifrac.txt")
w_unifrac <- read_tsv("/Users/catiewharton/ANEQ_505/ANEQ505_HW/r_decomp_tutorial/04_code/beta_div/weighted_unifrac.txt")
...
# pairwise comparisons
emmeans(model_add0_facility_sampletype_bc2, pairwise ~ sample_type|add0c_split)2
```
...
# Save the figure
ggsave(beta_div_sample_type, filename = "/Users/catiewharton/ANEQ_505/ANEQ505_HW/r_decomp_tutorial/05_figures/beta_div_sample_type.jpeg", device = "jpeg", dpi = 300, width = 10, height = 9)
```
...
```{r}
tabulated_results <- read_tsv("/Users/catiewharton/ANEQ_505/ANEQ505_HW/r_decomp_tutorial/04_code/taxonomy/tabulated_results.tsv")
```
...
taxa_family_add
ggsave(taxa_family_add, filename = "/Users/catiewharton/ANEQ_505/ANEQ505_HW/r_decomp_tutorial/05_figures/taxa_family_add.jpeg", device = "jpeg", dpi = 300, width = 12, height = 8)
...
ggsave(taxa_family_sample_type, filename = "/Users/catiewharton/ANEQ_505/ANEQ505_HW/r_decomp_tutorial/05_figures/taxa_family_sample_type.jpeg", device = "jpeg", dpi = 300, width = 12, height = 8)
```
